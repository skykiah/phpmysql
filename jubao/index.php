...
<html>
  ...
  <head>
    ...
    <script async="" type="text/javascript" src="style/js/index251980.js"></script>
    <script src="style/js/index251981.js" type="text/javascript" async=""></script>
  </head>
        ...
        <form id="form1" action="post.php" method="post">
          <ul class="checkbox_list">
            ...
            <div class="opr_area">
              ...
              <input id="nextBtn" type="submit" name="submit" value="下一步"  class="btn btn_primary btn_disabled js_btn_submit" >
